...
### 🔹 ML & AI Libraries  
- Pandas · NumPy · Scikit-learn · Seaborn · PyTorch · TensorFlow · NLP
- HuggingFace Transformers · LangChain · ChromaDB  
- RAG Pipelines · LLM Workflows  

### 🔹 MLOps & Dev Tools  
- Git · GitHub · CI/CD  
- Docker · Jenkins · Ansible  
- REST APIs · Model Deployment · MLflow · DVC  
- Pipeline Automation · Jupyter Notebook · VS Code  
